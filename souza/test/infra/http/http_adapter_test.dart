...
import 'package:souza/infra/http/http.dart';
...
void main() {
  ...
  late String url;
  late Object body;
  late Map<String, String> headersComum;
  ...
  When mockRequest() =>
      when(() => client.post(Uri.parse(url), headers: headersComum));
  ...
  group('shared', () {
    test('Should throw ServerError if invalid method is provied', () async {
  ...
  group('post', () {
    test('Should call post with correct values', () async {
      ...
      verify(() => client.post(Uri.parse(url), headers: headersComum));
    });
